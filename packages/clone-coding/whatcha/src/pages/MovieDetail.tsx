...
import DefaultInfo from "../features/movie/pages-detail/DefaultInfo";
import Similar from "../features/movie/pages-detail/Simillar";
...
const MovieDetail: React.FC = () => {
  // useParams => react-router-dom v5에서.. URL Query를 다룰 떄
